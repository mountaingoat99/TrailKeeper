...
public class StateListHelper {
    ...
    public static String GetStateName(String abbreviation) {
        String correctStateName = "Unknown";
        for (Map.Entry<String, String> state : getStates().entrySet()) {
            if (abbreviation.contains(state.getValue()))
                correctStateName = state.getKey();
        }
