...
public class MyFloatingActionButton extends View {
    ...
    static public class Builder {
        ...
        public MyFloatingActionButton create() {
            final MyFloatingActionButton button = new MyFloatingActionButton(activity);
